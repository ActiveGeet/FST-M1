...
public class Activity2 {
    ...
    public void addNewUserFromFile() throws IOException {
        ...
        response.then().body("message", equalTo("1007"));
        System.out.println("Test1: "+response.getBody().asPrettyString());
    }
    ...
    public void getUserInfo() {
        ...
        try {
            ...
            System.out.println("Get File Path: "+outputJSON.getPath());
        ...
        // Assertion
        response.then().body("id", equalTo(1007));
