...
public class Activity11_4 {
	...
	public static void main(String[] args) {
        ...
        WebElement newTabText = driver.findElement(By.xpath("//div[@class='content']"));
        wait.until(ExpectedConditions.visibilityOf(newTabText));
        ...
        //Get heading on new page
        newTabText = driver.findElement(By.xpath("//div[@class='content']"));
        wait.until(ExpectedConditions.visibilityOf(newTabText));
        System.out.println("New tab heading is: " + newTabText.getText());
